      ...
      <div
        ...
        <div className="lg:px-4 lg:mt-12 ">
          ...
          <div className="mt-6 text-gray-800">
            <p className="mb-4">I&apos;m an indie game developer and programmer.
            </p>
            <p className="mb-4">I&apos;ve been developing games, programs, and websites for many years, and have made many projects. See <Link href="/projects"><a className="font-bold transition-colors hover:text-sky-500">projects page</a></Link> for a list of all the projects I&apos;ve made.
            </p>
          </div>
          <div className="mt-6 text-gray-800">
          <p className="mb-4">
              I have experience in a large number of tools and languages, including...
            </p>
